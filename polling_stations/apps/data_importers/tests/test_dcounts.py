...
class DemocracyCountsImportTests(TestCase):
    ...
    uprns = ["1", "2", "3", "4", "5", "6"]
    addressbase = [
        {"address": "158 Wood Street,Barnet", "postcode": "EN5 4DB", "uprn": "1",},
        {"address": "162 Wood Street,Barnet", "postcode": "EN5 4DB", "uprn": "2",},
        {"address": "164 Wood Street,Barnet", "postcode": "EN5 4DB", "uprn": "3",},
        {
    ...
    def test_station_ids(self):
        ...
        expected = set([("1", "B6/1"), ("3", "B6/1"), ("5", "B60/1"), ("6", "B60/1"),])
