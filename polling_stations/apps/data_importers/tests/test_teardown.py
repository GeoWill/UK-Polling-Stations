...
class TestTeardown(TestCase):
    def setUp(self):
        councils = [
            {"council_id": "X01000000", "identifiers": ["X01000000"]},
            {"council_id": "X01000001", "identifiers": ["X01000001"]},
        ]
        ...
        pollingstations = [
            {
                "council": Council.objects.get(pk="X01000000"),
        ...
        for report in reports:
            DataQuality.objects.update_or_create(**report)
    ...
    def test_teardown_one_council(self):
        ...
        self.assertListEqual(
            ...
            [("X01000000", "ps1"), ("X01000000", "ps2"), ("X01000001", "ps1"),],
        )

        self.assertEqual(
            DataQuality.objects.get(council_id="X01000000"),
            DataQuality(
                **{
                    "council_id": "X01000000",
                    "report": "foo",
        ...
        self.assertListEqual(
            ...
            sorted([("X01000001", "ps1"), ("X01000000", ""), ("X01000000", ""),]),
        )
        self.assertEqual(
            DataQuality.objects.get(council_id="X01000000"),
            DataQuality(
    ...
    def test_teardown_all_councils(self):
        ...
        self.assertEqual(
            DataQuality.objects.get(council_id="X01000001"),
            DataQuality(
                **{
                    "council_id": "X01000001",
                    "report": "",
